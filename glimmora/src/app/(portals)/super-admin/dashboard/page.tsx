...
import { useSuperAdminDashboard } from "@/lib/hooks/use-super-admin";
import { Skeleton } from "@/components/shared/feedback/loading-skeleton";
import { ErrorState } from "@/components/shared/feedback/error-state";
import { formatNumber, formatRelative, formatCompact } from "@/lib/utils/format";
      ...
      <div className="relative px-8 pt-6 lg:px-10">
        ...
        <div className="mt-10">
          <div className="mb-4 flex items-center justify-between">
            ...
            <Link href="/super-admin/universities" className="flex items-center gap-1 text-sm font-medium text-primary-500 hover:text-primary-600">
          ...
          <div className="overflow-hidden rounded-lg bg-card shadow-lg shadow-primary-900/[0.04] ring-1 ring-border/30">
            ...
            <div className="divide-y divide-border/40">
              {data.recentOnboardings.map((o) => (
                <Link key={o.id} href={`/super-admin/universities/${o.id}`}
        ...
        <div className="mb-4 mt-10 flex items-center gap-10 rounded-lg bg-card px-8 py-6 shadow-lg ring-1 ring-border/30 shadow-primary-900/[0.04]">
          ...
          <div className="ml-auto">
            <Link href="/super-admin/monitoring" className="flex items-center gap-2 rounded-lg bg-primary-500 px-5 py-2.5 text-sm font-medium text-white shadow-lg shadow-primary-500/25 transition-all hover:-translate-y-0.5 hover:bg-primary-600">
